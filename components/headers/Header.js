...
const Header = () => {
    ...
    return (
        <header className="py-2 md:py-0 lg:px-2 flex sticky top-0 items-center shadow-sm">
            <Button
                color="gray"
                buttonType="outline"
                size="regular"
            ...
            <div className='mx-5 lg:mx-20 flex flex-grow items-center px-5 py-2 
            bg-gray-100 text-gray-700 rounded-lg focus-within:text-gray-900 focus-within:shadow-md'>
                <SearchIcon className="h-7" />
                <input type="text" placeholder="Search" className="flex-grow px-5 py-2 text-base bg-transparent outline-none" />
            </div>
            <Button
                color='gray'
                buttonType='outline'
